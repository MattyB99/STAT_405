...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, out.width="0.65\\linewidth", out.height="0.65\\linewidth", fig.align="center"}
...
```{r that time of the week, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, out.width="0.85\\linewidth", out.height="0.85\\linewidth", fig.align="center"}
...
```{r that time of the month, echo=FALSE, fig.height=4, message=FALSE, warning=FALSE, cache=TRUE, fig.align="center"}
