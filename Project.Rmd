---
title: "Parking Violations in LA"
...
```{r 3D_Map, echo=FALSE, out.width="0.69\\linewidth", out.height="0.69\\linewidth", fig.align="center", message=FALSE, warning=FALSE}
...
```{r, fig.height = 6, fig.width = 7, align = 'center', echo=FALSE, warning=FALSE, message=FALSE}
demMap
```
...
```{r holidays, echo=FALSE, fig.align="center", message=FALSE, warning=FALSE, out.width="1.5\\linewidth", out.height="1.5\\linewidth"}
...
#### Conclusions
we did traditional analysis but also looked at the dataset from different angles

The Parking Citaitons Analysis evolved into more than just a matter of counting. Our first graphs uncovered startling statistics about prices and fines. When looking at the most cited color and car types, our analysis revealed that special vehicles like ambulances, golf carts, forklifts, and tankers also were subject to Los Angeles parking enforcement. Excited by the potential of what this dataset offered, we saught to use complementary datasets to dive deeper into the socio-economic, cultural, and geographical effects on Los Angeles parking Citations. 
