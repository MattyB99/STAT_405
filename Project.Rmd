...
grid.text(label="Parking Tickets By Year",x=.5, y=1.05, gp=gpar(fontface="bold", cex=1.5))
grid.xaxis(at=x)
...
df <- data.frame(Year=seq(from=2010, to=2020, by=1),
         "Dollars_Collected" =c(730, 630, 2276, 3062, 2371400, 107172874, 130124585,151608139,124738695,75291586,2275))
